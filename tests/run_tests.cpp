...
int main(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (arg == "--tensor" || arg == "-t") {
            ...
            printf("  --gradcheck, -g   Run numerical gradient checking tests\n");
    ...
    if (run_all || run_gradcheck) {
        runner.add_suite(create_grad_check_tests());
    }
