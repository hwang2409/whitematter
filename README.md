...
Full API documentation is available at [`/docs`](http://localhost:8080/docs) (Swagger UI) and [`/redoc`](http://localhost:8080/redoc) when the server is running. These include request/response schemas, authentication details, and interactive "try it out" support.
