...
from schemas import ModelMetadata, TrainStatus, GenerateRequest
from dependencies import (
    dataset_manager, dataset_service,
...
@router.post("/api/{model_id}/generate")
